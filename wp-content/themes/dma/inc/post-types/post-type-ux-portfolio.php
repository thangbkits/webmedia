...
class Featured_Item_Post_Type {
	...
	protected function register_post_type() {
		$labels = array(
			...
			'add_new'            => __( 'Thêm dự án mới', 'flatsome-admin' ),
			'add_new_item'       => __( 'Thêm dự án mới', 'flatsome-admin' ),
			'edit_item'          => __( 'Sửa dự án', 'flatsome-admin' ),
			'new_item'           => __( 'Tạo mới', 'flatsome-admin' ),
			'view_item'          => __( 'Xem dự án', 'flatsome-admin' ),
			'search_items'       => __( 'Tìm kiếm', 'flatsome-admin' ),
			'not_found'          => __( 'Không có dự án', 'flatsome-admin' ),
			'not_found_in_trash' => __( 'Không có dự án trong thùng rác', 'flatsome-admin' ),
		);
	...
	protected function register_taxonomy_tag() {
		$labels = array(
			'name'                       => __( 'Thẻ', 'flatsome-admin' ),
			'singular_name'              => __( 'Thẻ', 'flatsome-admin' ),
			'menu_name'                  => __( 'Thẻ', 'flatsome-admin' ),
			'edit_item'                  => __( 'Sửa thẻ', 'flatsome-admin' ),
			'update_item'                => __( 'Cập nhật thẻ', 'flatsome-admin' ),
			'add_new_item'               => __( 'Thêm thẻ', 'flatsome-admin' ),
			'new_item_name'              => __( 'Thêm thẻ', 'flatsome-admin' ),
			'parent_item'                => __( 'Parent Tag', 'flatsome-admin' ),
			'parent_item_colon'          => __( 'Parent Tag:', 'flatsome-admin' ),
			'all_items'                  => __( 'Tất cả các thẻ', 'flatsome-admin' ),
			'search_items'               => __( 'Tìm thẻ', 'flatsome-admin' ),
			'popular_items'              => __( 'Thẻ phổ biến', 'flatsome-admin' ),
			'separate_items_with_commas' => __( 'Phân cách các thẻ bằng dấu phẩy (,).', 'flatsome-admin' ),
			'add_or_remove_items'        => __( 'Thêm hoặc xóa thẻ', 'flatsome-admin' ),
			'choose_from_most_used'      => __( 'Chọn từ các thẻ được sử dụng nhiều nhất', 'flatsome-admin' ),
			'not_found'                  => __( 'Không tìm thấy thẻ.', 'flatsome-admin' ),
		);
	...
	protected function register_taxonomy_category() {
		...
		$labels = array(
			'name'                       => __( 'Danh mục', 'flatsome-admin' ),
			'singular_name'              => __( 'Danh mục', 'flatsome-admin' ),
			'menu_name'                  => __( 'Danh mục', 'flatsome-admin' ),
			'edit_item'                  => __( 'Sửa Danh mục', 'flatsome-admin' ),
			'update_item'                => __( 'Cập nhật Danh mục', 'flatsome-admin' ),
			'add_new_item'               => __( 'Thêm danh mục', 'flatsome-admin' ),
			'new_item_name'              => __( 'Thêm mới', 'flatsome-admin' ),
			'parent_item'                => __( 'Danh mục hiện tại', 'flatsome-admin' ),
			'parent_item_colon'          => __( 'Danh mục hiện tại:', 'flatsome-admin' ),
			'all_items'                  => __( 'Tất cả danh mục', 'flatsome-admin' ),
			'search_items'               => __( 'Tìm kiếm danh mục', 'flatsome-admin' ),
			'popular_items'              => __( 'Danh mục phổ biến', 'flatsome-admin' ),
			'separate_items_with_commas' => __( 'Phân cách các thẻ bằng dấu phẩy (,).', 'flatsome-admin' ),
			'add_or_remove_items'        => __( 'Thêm hoặc xóa danh mục', 'flatsome-admin' ),
			'choose_from_most_used'      => __( 'Chọn từ các loại được sử dụng nhiều nhất', 'flatsome-admin' ),
			'not_found'                  => __( 'Không tìm thấy danh mục.', 'flatsome-admin' ),
		);
	...
	public function add_thumbnail_column( $columns ) {
		$column_thumbnail = array( 'Ảnh' => __( 'Thumbnail', 'flatsome-admin' ) );
